...
const insuranceOptions = [
    { id: 'super economico', label: <p className="flex flex-col gap-0 text-slate-800/80"><span className="font-bold text-slate-700">Super económico</span> Lo justo en clinicas, cobertura integral pero oncológico limitado</p>, value: 'superEconomico' },
    ...
    { id: 'gama alta', label: <p className="flex flex-col gap-0 text-slate-800/80"><span className="font-bold text-slate-700">Gama alta</span> Todas las clinicas, reembolso, mejores deducibles</p>, value: 'gamaAlta' }
]
