...
const discountOptions = [
    ...
    { id: 'no-ahora_descuento', label: <p className="flex flex-col text-slate-800/80"><span className="font-bold text-slate-700">Actualmente no</span>Tuve hace menos de 90 días.</p>, value: 'no-ahora' }, 
